...
public final class MagicTools {
    ...
    public static void main(String[] args) {
        // https://api.screenscraper.fr/api2/jeuInfos.php?devid=muldjord&devpassword=uWu5VRc9QDVMPpD8&softname=skyscraper3.20.3&output=json&ssid={ssid}&sspassword=zjkiki225&gameid=1513
